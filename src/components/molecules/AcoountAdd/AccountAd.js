    ...
    <Container>
      ...
      <Wrapper>
        <form onSubmit={handleSubmit}>
          ...
          <Checkbox>
            <label htmlFor='addImagesCheckbox'>
              Chesz dodać zdjęcia? maks. 5
            </label>
            <input
              type='checkbox'
          ...
          <div>
            ...
            {errors.selectedCity && <Error>Proszę wybrać miasto.</Error>}
            {errors.selectedProfession && (
              <Error>Proszę wybrać specjalizację.</Error>
            )}
            {errors.companyName && <Error>Proszę podać nazwę firmy.</Error>}
            {errors.phoneNumber && <Error>Proszę podać numer telefonu.</Error>}
            {errors.shortDescription && (
              <Error>Proszę podać krótki opis.</Error>
            )}
            {errors.longDescription && <Error>Proszę podać długi opis.</Error>}
          </div>
          <Add>
            <div>
