  ...
  return (
    <Wrapper>
        <select value={selectedOption} onChange={handleSelectChange} >
         ...
         {selectedOption && <select value={selectedOptionSecond} onChange={handleSelectChangeSecond}>
        ...
        {selectedOptionSecond && <select value={selectedOptionThird} onChange={handleSelectChangeThird}>
          <option value=''>Wybierz Miasto</option>
